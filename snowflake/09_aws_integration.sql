...
CREATE OR REPLACE STORAGE INTEGRATION aws_vietnam_textile_supply_chain_S3_INT
  ...
  ENABLED = TRUE
  STORAGE_ALLOWED_LOCATIONS = ('s3://<YOUR_S3_BUCKET>/aws-vietnam-textile-supply-chain/');
...
CREATE OR REPLACE STAGE RAW.LANDING_STAGE
  ...
  URL = 's3://<YOUR_S3_BUCKET>/aws-vietnam-textile-supply-chain/';

-- ==================== KINESIS / IOT CORE INGESTION ====================
-- Snowpipe from Kinesis Data Stream
-- Stream ARN: arn:aws:kinesis:ap-southeast-1:<YOUR_AWS_ACCOUNT_ID>:stream/aws-vietnam-textile-supply-chain-stream
